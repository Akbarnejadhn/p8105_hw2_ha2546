...
On the final step for this problem, I first left-joined the _snp_data_ to _pols_month_data_, using key variables _year_ and _month_, and then left-joined the _unemployment_data_ to the result.
